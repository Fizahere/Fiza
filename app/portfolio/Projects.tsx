            ...
            <div className="relative mt-10 group/carousel">
                {isMounted && totalPages > 1 && (
                    <button
                        ...
                        className={`absolute -left-3 md:-left-9 2xl:-left-12 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-sky-500/80 text-white p-3 rounded-full transition-all duration-300 z-10 cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed ${
                            canScrollLeft ? "opacity-100 hover:scale-110" : "opacity-30"
                        }`}
                ...
                {isMounted && totalPages > 1 && (
                    <button
                        ...
                        className={`absolute -right-3 md:-right-9 2xl:-right-12 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-sky-500/80 text-white p-3 rounded-full transition-all duration-300 z-10 cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed ${
                            canScrollRight ? "opacity-100 hover:scale-110" : "opacity-30"
                        }`}
                        ...
                        {Array.from({ length: totalPages }).map((_, idx) => (
                            <button
                                ...
                                className={`h-2.5 rounded-full transition-all duration-300 cursor-pointer ${
                                    activeIndex === idx ? "w-8 bg-sky-500" : "w-2.5 bg-neutral-600 hover:bg-neutral-400"
                                }`}
